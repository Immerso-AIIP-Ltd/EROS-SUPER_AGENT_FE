...
const HealthAgent = () => {
  ...
  const [messages, setMessages] = useState([
    {
      id: 1,
      text: "Welcome to Health Agent! I'm here to help you with health-related queries — diet, fitness, supplements, or wellness.",
      sender: 'bot',
      timestamp: new Date()
    }
  ]);
  ...
  const [activeItem, setActiveItem] = useState('Health Agent');
  ...
  const handleSendMessage = async () => {
    ...
    setTimeout(() => {
      const botResponse = {
        id: Date.now() + 1,
        text: generateHealthResponse(message),
        sender: 'bot',
        timestamp: new Date()
      };
  ...
  const generateHealthResponse = (userInput) => {
    const responses = [
      "I can help you choose the right AI tools for your health goals. What specific area are you interested in?",
      "Whether it's nutrition, fitness, or lifestyle optimization — I’ve got tools to help you work smarter.",
      "Would you like recommendations for AI-powered health apps or dietary analysis tools?",
      "Looking for a personalized fitness plan or supplement suggestion? Ask away!",
      "From sleep tracking to stress management — AI can help. What would you like?"
    ];
  ...
  return (
    <div className="d-flex min-vh-100" style={{ backgroundColor: '#ffffff', color: '#000000', fontFamily: "'Poppins', sans-serif" }}>
      ...
      >
        ...
        >
          <h2 className="text-black mb-0">Health AI Agent</h2>
                ...
                >
                  ...
                  <div className="d-flex flex-column">
                    <div
                      ...
                      style={{
                        backgroundColor: msg.sender === 'user' ? '#e6e6e6' : '#f5f5f5',
      ...
      <span>{selectedModel}</span>
            ...
            <div className="position-relative">
              <textarea
                ...
                placeholder="Ask about diet, exercise, or health plans..."
                value={message}
