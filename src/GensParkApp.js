...
const GensParkApp = () => {
  ...
  const [messages, setMessages] = useState([
    {
      id: 1,
      text: "Welcome to Eros AI Chat! I'm here to help you with ai tools,project?",
      sender: 'bot',
      timestamp: new Date()
    }
  ]);
  ...
  const handleSendMessage = async () => {
    ...
    setTimeout(() => {
      const botResponse = {
        id: Date.now() + 1,
        text: generateErosResponse(message),
        sender: 'bot',
        timestamp: new Date()
      };
  ...
  const generateErosResponse = (userInput) => {
    const responses = [
      "I can help you choose the right AI tools for your task. Could you tell me more about what you're trying to achieve?",
  ...
  return (
    <div className="d-flex min-vh-100" style={{ backgroundColor: '#ffffff', color: '#000000' }}>
      {/* Sidebar */}
      <div
      ...
      <div
        ...
        style={{ marginLeft: '250px', display: 'flex', flexDirection: 'column', height: '100vh' }}
      >
        {/* Header */}
        <div
        ...
        >
          <h2 className="text-black mb-0"> Eros AI Chat</h2>
    ...
    >
      ...
      <span>{selectedModel}</span>
              ...
              <div className="form-check">
                ...
                />
                <label className="form-check-label ms-2" htmlFor="searchWeb" style={{ color: '#000000' }}>
                  Search Web
                </label>
              </div>
            </div>
            ...
            <div className="position-relative">
              <textarea
                ...
                placeholder="Ask about AI tools, productivity apps, automation, or workflow optimization..."
                value={message}
